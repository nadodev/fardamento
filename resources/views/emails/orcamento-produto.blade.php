    ...
    <div class="container">
        ...
        <div class="info-section">
            ...
            <div class="info-item">
                ...
                <span class="info-value">{{ $quantidade }} unidades</span>
            </div>
            @endif
        </div>
        ...
        <div class="produto-box">
            ...
            <div class="info-item">
                <span class="info-label">Nome:</span>
                <span class="info-value">{{ $produtoNome }}</span>
            </div>
            <div class="info-item">
                <span class="info-label">Código:</span>
                <span class="info-value">{{ $produtoCodigo }}</span>
            </div>
        </div>
        ...
        <div class="footer">
            <p>Esta solicitação foi enviada através do formulário de orçamento do site {{ config('app.name') }}.</p>
